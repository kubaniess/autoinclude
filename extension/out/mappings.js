...
exports.C_MAPPINGS = exports.CPP_MAPPINGS = void 0;
exports.lookupHeader = lookupHeader;
exports.CPP_MAPPINGS = {
    // I/O
    cout: "iostream",
    cin: "iostream",
    cerr: "iostream",
...
function lookupHeader(symbol, isCpp) {
    if (isCpp) {
        return exports.CPP_MAPPINGS[symbol] ?? exports.C_MAPPINGS[symbol];
    }
    return exports.C_MAPPINGS[symbol];
}
